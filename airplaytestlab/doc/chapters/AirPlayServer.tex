  ...
  \begin{center}
    \begin{tikzpicture}[node distance=1.5cm, auto]
      ...
      \node[draw, thick, rounded corners, text centered, text width=3.5cm, above of=airplayserver, fill=yellow!20] (mainactivity) {MainActivity};
      ...
      \draw[->, thick] (mainactivity) -- node[midway, left] {uses} (airplayserver);
